...
.controller('MenuController', ['$scope', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function ($scope, menuFactory, favoriteFactory, baseURL, $ionicListDelegate, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
    ...
    menuFactory.query(
        function (response) {
            ...
            console.log(" dishes in querey",$scope.dishes);
        },
        function (response) {
        });
    ...
    $scope.select = function (setTab) {
        ...
        if (setTab === 2) {
            $scope.filtText = "veggies";
        } else if (setTab === 3) {
            $scope.filtText = "spices";
        } else if (setTab === 4) {
            $scope.filtText = "fruit";
        } else {
            $scope.filtText = "";
        }
    };
    ...
    $scope.addFavorite = function (dishid) {
        ...
        console.log("the plant", $scope.plants[dishid]);
        ...
        $ionicPlatform.ready(function () {
                ...
                $cordovaLocalNotification.schedule({
                    ...
                    console.log('Added Plant '+$scope.dishes[dishid].name);
                },
                function () {
              ...
              $cordovaToast
                  .show('Added Plant '+$scope.dishes[dishid].name, 'long', 'center')
